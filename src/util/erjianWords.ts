...
export const erjian1xuan: string[] = [
...
export const erjian1xuanZhongdian: string[] = [
  '难道', '一定', '因为', '拼音', '简单', '所以', '我们', '从来', '只能', '习惯',
  '反正', '五笔', '出现', '可能', '需要', '解决', '非常', '问题', '成为', '结果',
  '双拼', '明显', '容易', '自己', '现在', '发现', '简直', '方便', '相当', '喜欢',
  '本来', '准备', '首先', '统一', '了解', '一下', '目前', '知道', '根本', '浪费',
...
export const erjian2xuan: string[] = [
  '刚刚', '慢慢', '渐渐', '试试', '尝尝', '恰恰', '背景', '伤害', '程度', '附件',
  '支持', '选择', '学习', '情况', '每天', '电脑', '公司', '速度', '完美', '悠闲',
  '修改', '修正', '回复', '感觉', '面前', '前面', '下面', '假如', '更新', '推荐',
  '推导', '达到', '链接', '追求', '困难', '极其', '极致', '极为', '束缚', '搜索',
  '这些', '总算', '淘汰', '投资', '虽然', '真正', '绝对', '任务', '发送', '规则',
  '否则', '尽管', '仍然', '分别', '直到', '味道', '歧视', '从前', '征服', '世纪',
  '这次', '微信', '推广', '主意', '意志', '小时', '只是', '只会', '未知', '座位',
  '参加', '反悔', '打算', '随着', '等着', '跟着', '分钟', '总共', '一边', '两边',
